...
### DQN table (10)
![DQN Results Table](../visualizations/dqn_results_table.png)

### PPO table (10)
![PPO Results Table](../visualizations/ppo_results_table.png)

### A2C table (10)
![A2C Results Table](../visualizations/a2c_results_table.png)

### REINFORCE table (10)
![REINFORCE Results Table](../visualizations/reinforce_results_table.png)
...
![Generalization](../visualizations/generalization.png)
...
Use this while recording final submission:
- [ ] Full screen shared
- [ ] Camera ON
...
The required template files are present:
...
Option 1: Open this Markdown file and print to PDF.  
Option 2 (Pandoc):

```bash
pandoc outputs/reports/SUMMATIVE_REPORT_TEMPLATE_FILLED.md -o outputs/reports/SUMMATIVE_REPORT_TEMPLATE_FILLED.pdf
```
